...
This is the K2401 module from PyNE-probe package, implemented here for monitoring the Ag/AgCl voltage and Ag/AgCl current
"""
...
class Keithley2401(Instrument.Instrument):
    ...
    def _getSenseLevel(self):
        ...
        measCurrent = float(tempData[1])/self.scaleFactor
        measVoltage = float(tempData[0])
