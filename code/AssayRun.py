...
from Imports import *
from Config import P1Gain, P2Gain, VSource, ItersAR, WaitAR
import pandas as pd
import time
...
def measLoop():
    ...
    for i in range(nRows):
        Row = i+1
#        print('Row = ',Row) ## Keep for diagnostics; Off from 15JAN24 APM
        DevL = i+1
        DevR = 52-i
#        print('Device Left =', DevL ,'Device Right =', DevR) ## Keep for diagnostics; Off from 15JAN24 APM
