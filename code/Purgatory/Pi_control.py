...
Moved to purgatory 17APR24 APM -- Old code
...
from Config import PiBox, MuxMode, MuxGen
import time
...
class PiMUX:
    ...
    def __init__(self):
        ...
        if MuxGen == 'Gen3a': # Option to be removed once Gen3a is phased out for Gen4, likely mid-2024
